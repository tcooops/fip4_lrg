...
<h1 class="hidden">Admin LogIn</h1>
    ...
    <h1 class="hidden">User Confirmed</h1>
    
        <section class="admin">
            <h2>Success! You have created a new account.</h2>
            <h3>Thank you for signing up with LRG!</h3>
            <p>Go back to <a id="go-back" href="index.php">Admin Dashboard</a></p>
            <p>Go back to <a id="go-back" href="../index.php">Homepage</a></p>
        </section>
        <footer>
