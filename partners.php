    ...
    <?php include 'templates/header.php'; ?>
        ...
        <section>
            <div id="partners-con">
                ...
                <ul>
                    <li class="partner">
                        <a href="https://www.hockeycanada.ca/en-ca/home" target="new"><img src="images/placeholder.jpg" alt="Hockey Canada"></a>
                        <hr>
                        <h3>Hockey Canada</h3>
                    </li>
                    <li class="partner">
                        <a href="https://www.ohf.on.ca " target="new"><img src="images/placeholder.jpg" alt="OHF"></a>
                        <hr>
                        <h3>OHF</h3>
                    </li>
                    <li class="partner">
                        <a href="https://alliancehockey.com" target="new"><img src="images/placeholder.jpg" alt="Alliance"></a>
                        <hr>
                        <h3>Alliance</h3>
                    </li>
                    <li class="partner">
                        <a href="https://www.omha.net" target="new"><img src="images/placeholder.jpg" alt="OMHA"></a>
                        <hr>
                        <h3>OMHA</h3>
                    </li>
                    <li class="partner">
                        <a href="https://www.owha.on.ca" target="new"><img src="images/placeholder.jpg" alt="OWHA"></a>
                        <hr>
                        <h3>OWHA</h3>
                    </li>
                    <li class="partner">
                        <a href="http://www.ohahockey.ca" target="new"><img src="images/placeholder.jpg" alt="OHA"></a>
                        <hr>
                        <h3>OHA</h3>
                    </li>
                    <li class="partner">
                        <a href="https://sportabilitybc.ca" target="new"><img src="images/placeholder.jpg" alt="Sledge Hockey"></a>
                        <hr>
                        <h3>Sledge Hockey</h3>
                    </li> 
                </ul>
